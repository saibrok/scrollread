    ...
    <section class="card">
      ...
      <div class="controls">
        <div class="control">
          ...
          <div class="stat-line">Всего слов: <strong>{{ props.stats.words }}</strong></div>
          <div class="stat-line">Всего символов: <strong>{{ props.stats.chars }}</strong></div>
          <div class="stat-line">Без пробелов: <strong>{{ props.stats.charsNoSpaces }}</strong></div>
        </div>
        ...
        <div class="control">
          ...
          <div class="meta">Оценка времени: <span>{{ props.timeRange }}</span></div>
        </div>

        <div class="control">
          <div class="label">Тема интерфейса</div>
          <UiSelect :model-value="props.theme" @update:model-value="emit('update:theme', $event)">
        ...
        <UiButton class="start" :disabled="!props.canStart" @click="emit('start')">
          НАЧАТЬ
        </UiButton>
      </div>
    </section>
